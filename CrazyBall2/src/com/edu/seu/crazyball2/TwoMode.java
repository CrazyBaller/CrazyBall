...
import com.edu.seu.crazyball2.SoloMode.BodyData;
...
public class TwoMode implements ApplicationListener, ContactListener,
	...
	private void createWorld() {
		...
		// 创建挡板
		tBoard0 = B2Util.createRectangle(world, SCREEN_WIDTH * boardrate,
				board_halfheight, 0, 0, BodyType.StaticBody, 0, 0, 0, 0,
				new BodyData(BodyData.BODY_BOARD), null);
		tBoard2 = B2Util.createRectangle(world, SCREEN_WIDTH * boardrate,
				board_halfheight, 0,SCREEN_WIDTH-2*board_halfheight, BodyType.StaticBody, 0, 0, 0, 0,
				new BodyData(BodyData.BODY_BOARD), null);
	...
	public void render() {
		...
		batch.draw(texture2, set_x - 20f + x * 10, set_y - 120f + y * 10, 40f,
				40f);
		batch.end();
		stage.act();
		stage.draw();
		...
		tBoard2.setTransform(board2_x, board2_y, 0);
	...
	public void postSolve(Contact arg0, ContactImpulse arg1) {
		...
		if ((dA.getType() == BodyData.BODY_BALL && dB.getType() == BodyData.BODY_BOTTOM)
				|| (dA.getType() == BodyData.BODY_BOTTOM && dB.getType() == BodyData.BODY_BALL)) {
			// dA.health = 0;
			stage.addActor(dialogWindow);
